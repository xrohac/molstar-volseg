...
from cellstar_preprocessor.flows.segmentation.category_set_downsampling_methods_amd import (
	process_downsampling_gpu
)
...
from cellstar_preprocessor.flows.segmentation.gpu_opencl_downsample import (
    gpu_opencl_downsample
)

def sff_segmentation_downsampling_amd(internal_segmentation: InternalSegmentation):
    ...
    for i in range(downsampling_steps):
        ...
        levels.append(
            process_downsampling_gpu(
				...
				previous_level_dict=levels[i],
				current_set_table=current_set_table,
    			value_to_segment_id_dict_for_specific_lattice_id=value_to_segment_id_dict_for_specific_lattice_id
			)
